...
public class HDFSClient {
	...
	public boolean ifExists (Path source) throws IOException{
		...
		config.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/core-site.xml"));
		config.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/hdfs-site.xml"));
		config.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/mapred-site.xml"));
	...
	public void getBlockLocations(String source) throws IOException{
		...
		conf.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/core-site.xml"));
		conf.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/hdfs-site.xml"));
		conf.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/mapred-site.xml"));
	...
	public void uploadFile(String dest,InputStream in) throws IOException{
		// Conf object will read the HDFS configuration parameters
		Configuration conf = new Configuration();
		conf.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/core-site.xml"));
		conf.addResource(new Path("/home/gaurav/softwares/hadoop-0.20.2/conf/hdfs-site.xml"));
...
/*		InputStream in = new BufferedInputStream(new FileInputStream(
				new File(source)));
*/
		int bytesize = 1024 * 1024 * 10;
		//byte[] b = new byte[1024];
		byte[] b = new byte[bytesize];
		int numBytes = 0;
		InputStream bin= new BufferedInputStream(in);
		while ((numBytes = bin.read(b)) > 0) {
			out.write(b, 0, numBytes);
		}
